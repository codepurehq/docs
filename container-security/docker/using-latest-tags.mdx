---
title: Using Latest Tags (CIS 4.4)
...
* **Impact:** **Unpredictable Vulnerabilities.** Using `latest` implies that you do not control which version of the software is running. Your production environment might silently pull a new version containing breaking changes or unpatched vulnerabilities, rendering incident response and rollbacks impossible.
